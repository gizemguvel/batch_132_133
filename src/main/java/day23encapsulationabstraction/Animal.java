...
public abstract class Animal {
    ...
    /*
        1)Sometimes we do not need method body, that's why we should not type it
        ...
        6)To make a method abstract
            ...
            Note: after creating an abstract method do not forget to use them in all concrete child classes
                  if you do not use them in child classes, you will get error.
        ...
        8)You can use both "concrete methods" and "abstract methods" in abstract classes
        9)"Final Methods" must have constant method body but in abstraction every child class will use the abstract methods with a different body
        ...
        10)An "abstract class" cannot be "final" because, final class cannot have child classes but abstract class should have child classes
           to make "abstract methods" to be implemented in child class.
        11)Abstract classes can have abstract methods, abstract methods are uncompleted methods because they do not have body part.
           ...
           I mean the object will not be perfect, if an object is not perfect it can create issues
           Because of that Java does not let you create object from an abstract class
        12)abstract classes have constructor like other classes, but the constructor cannot create object.
        13)we create abstract method for the child classes to use, but if you make the access modifier private it means
           you do not want child class to use it. This is contradiction, that's why Java does not let make an abstract method private
