...
public class Arrays01 {
     ...
     */
        ...
        int numOfCharsInLastIndex=cities[cities.length-1].length();//5  by typing our coding syntax that works for every single array's
                                                                    //  last index element we need to type our code in dynamic way.
