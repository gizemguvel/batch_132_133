...
public class Students {
    ...
    /*
        ...
        2)When we crate a class Java puts a constructor in it, because Java knows classes are for creating objects.
        3)When you create a class you will not see any constructor in it, but the class has constructor, it is invisible constructor.
        ...
        8)What are the differences between "method" and the "constructor"?
            ...
            ii)methods are for some actions, but constructors are for object creation
