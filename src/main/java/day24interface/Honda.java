...
public class Honda implements Ac, Engine {
    ...
    /*
        ...
        3)Multiple inheritance is not supported for classes, if you use "interfaces" as parents Java will let you
          create multiple parents for a class.
        ...
        5)If you make a class dependent on another class completely(Tight Coupling) when the other class is broken
          your class will be broken as well, this is not good. That's why we prefer to create almost independent classes,
          this structure is called Loose Coupling.

        6)Interfaces are "fully abstract", meaning Interfaces cannot have concrete methods, all methods in an interface
          must be abstract method. As you know "abstract methods" must be implemented by "concrete child classes", if you
          want a developer not to forget any mandatory functionalities to implement for a child class, using interfaces is perfect.
          We name an interface as "To do list" for child classes.
        ...
        To make an "interface" parent of an "abstract class" use "implements" keyword instead of "extends"
          ...
          To make a "class" parent of a "class" use "extends"
        ...
        8)Methods in an interface are "public" and "abstract", that's why no need to type public and abstract when you create a method

        9)Interfaces don't have constructor, that's why you cannot create object from an interface.
        ...
        11)It is allowed to create methods with the same name in different parent interfaces
           But if you create methods with the same name in different parent interfaces,  make "parameters" and "return types" same as well.
