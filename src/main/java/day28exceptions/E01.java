...
public class E01 {
    ...
    //Example 1: Create a method divides an integer converted from a String by the 1 less than the number of characters of the String
    ...
    //3.way: How to handle multiple exceptions by using exceptions and any other
