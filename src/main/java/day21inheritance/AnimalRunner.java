...
public class AnimalRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myCat.age);//14==> Cat class ahs age variable thats why the object does not
                                      //        use the variable from the parent

        //When you create an object you can select the data type of the object from the class itself or
        //from any parent
