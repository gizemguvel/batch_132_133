...
public class LinkedList01 {
    ...
    public static void main(String[] args) {
        ...
        String str=names.removeFirst();
        System.out.println("str = " + str);Ali
        System.out.println(names);[Brad, Brad]
        ...
        */
        ...
        String res=students.poll();
        System.out.println("res = " + res);//Ali
